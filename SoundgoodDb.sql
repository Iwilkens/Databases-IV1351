...
VALUES
  ...
  ('TQP99SIK3JR','Suki Henderson',1,'beginner'),
  ('UWJ09YKS8XQ','Blake Mccormick',0,'beginner'),
  ('YFM78DHU3NC','Sara Ayers', 2,'intermediate'),
  ('XUI90WDG1UP','Tucker Carlson',2,'intermediate'),
  ('TLP60PLE1IP','Jacqueline Mcdaniel',1,'intermediate');
...
VALUES
  ...
  (4362733535,'Magee','Juarez'),
  (3890110243,'Jana','Larson'),
  (4487392288,'Malachi','Golden'),
  (3667697442,'Zelenia','Weber'),
  (3794324919,'Hilda','Merrill');
...
VALUES
  ...
  ('ac.metus@hotmail.couk'),
  ('amet.consectetuer.adipiscing@aol.ca'),
  ('purus.duis@icloud.edu'),
  ('eu@protonmail.ca'),
  ('nisl.quisque@icloud.couk');
...
VALUES
  ...
  ('TFM31GSM2XR','drums, guitar, music theory, piano, vocals'),
  ('RBG83IFD9UK','music theory, piano, vocals'),
  ('CLP47JQP2QQ','drums, guitar'),
  ('ZIV74DKH4NF','piano'),
  ('GEG05XMM6XB','music theory, piano, vocals');
...
VALUES
  ...
  ('vocals','ensemble',8,'rock','intermediate'),
  ('drums','ensemble',7,'pop','advanced'),
  ('vocals','ensemble',13,'pop','beginner'),
  ('music theory','ensemble',15,'rock','beginner'),
  ('guitar','ensemble',14,'rock','intermediate');
...
INSERT INTO lesson_booking (time_slot, instructor_id)
VALUES
  ('2022-10-15 11:00:00', 1),
  ('2022-08-01 14:00:00', 1),
  ('2022-11-09 15:00:00', 1),
  ('2022-01-20 14:00:00', 2),
  ('2022-12-10 16:00:00', 2),
  ('2022-11-12 11:00:00', 1),
  ('2022-11-07 14:00:00', 1),
  ('2022-11-09 15:00:00', 1),
  ('2022-11-08 14:00:00', 2),
  ('2022-11-11 16:00:00', 2);
...
INSERT INTO siblings (sibling_student_id)
VALUES
  (null),
  (1),
  (4),
